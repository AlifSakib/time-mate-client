            ...
            <div class="grid grid-cols-1 gap-y-8 lg:grid-cols-2 lg:items-center lg:gap-x-16">
              ...
              <div class="grid grid-cols-2 gap-4 sm:grid-cols-3">
                ...
                >
                  ...
                  <h2 class="mt-2 font-bold">Appointments Online</h2>

                  <p class="hidden sm:mt-1 sm:block sm:text-sm sm:text-gray-600 text-white">
                ...
                >
                  ...
                  <h2 class="mt-2 font-bold">Book Appointments</h2>
                ...
                >
                  ...
                  <h2 class="mt-2 font-bold">Save Time</h2>
                ...
                >
                  ...
                  <h2 class="mt-2 font-bold">Reduce No-shows</h2>
                ...
                >
                  ...
                  <h2 class="mt-2 font-bold">Streamline</h2>
                ...
                >
                  ...
                  <h2 class="mt-2 font-bold">Booking Process</h2>
